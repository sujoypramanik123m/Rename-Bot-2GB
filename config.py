...
class Config(object):
    ...
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8190721627:AAG4PHuYkATblKIaKR0PTlttMNDfb5YMCNY") 
...
╔════❰ ʀᴇɴᴀᴍᴇ ʙᴏᴛ ❱═❍⊱❁۪۪
║╭━━━━━━━━━━━━━━━➣
║┣⪼📃ʙᴏᴛ : [Fɪʟᴇ Rᴇɴᴀᴍᴇʀ Bᴏᴛ](https://t.me/ToppersRename_Robot)
║┣⪼👼Cʀᴇᴀᴛᴏʀ : [—‌‌‌‌𝙎𝙪𝙟𝙤𝙮™ </>](https://t.me/UncleChipssBot)
...
➲ /metadata: ᴛᴏ ꜱᴇᴛ ᴍᴇᴛᴀᴅᴀᴛᴀ
ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ sᴇᴛ ᴍᴇᴛᴀᴅᴀᴛᴀ ᴄʟɪᴄᴋ ᴏɴ sᴇᴛ ᴄᴜsᴛᴏᴍ ᴍᴇᴛᴀᴅᴀᴛᴀ
